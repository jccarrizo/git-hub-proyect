...
<form action="dashboard.php?data=ver_visit" method="post" >
    ...
    <caption>Datos del Vendedor</caption>
        ...
        <tbody>  
            ...
            <tr>
                ...
                <td><a target="_blank" style="color: black;" href="https://correo.metrodemaracaibo.gob.ve/mail/"><?php echo $correo_principal.'@metrodemaracaibo.gob.ve'; ?></a></td>
	...
	height: 300px;"/> </li>
        ...
        <center>
          <nav class="actions light"> <span id="nav-prev">&lt;</span> <span id="nav-next">&gt;</span><br />
              <br />
              <input type="button" name="Atrás" onclick="javascript:window.history.back(inicio);" class="btn btn-error" value="Atrás"/>
          </nav>
          <br/>
        </center>
      </strong></div>
