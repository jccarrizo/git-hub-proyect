...
if (@$_POST['perfil']){
  ...
  $sql="UPDATE perfiles SET perfil='".$perfil."', dperfil='".$dperfil."', role='".$permisos."' WHERE id_perfil=".$id;
      ...
      <div class="grid-16">
        ...
        <div class="grid-8">				
          <div class="widget">			
            ...
            <div style="float:right;font-size:80%;margin: 5px 5px 10px 0;">  <a href="#" class="seleccciona"  onclick="marcar(this);">Marcar todos</a> | <a href="#" class="resetea">Marcar ninguno</a> </div>
            <div class="widget-content">
