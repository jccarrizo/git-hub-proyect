                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-4 col-md-offset-4">
                                                      <div class="login-panel panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                          <form role="form" id="form_access" name="form_access" method="POST" action="bypass2.php">
                                                            <fieldset>
                                                              <div class="form-group">
                                                                <input onChange="javascript:this.value = this.value.toUpperCase();" autocomplete="off" class="form-control required" placeholder="Cedula" name="usuario" id="usuario" value="" autofocus>
                                                              </div>
                                                              <div class="form-group">
                                                                <input autocomplete="off" class="form-control required" placeholder="contraseña" name="clave" id="clave" type="password" value="">
                                                                  <div style="text-align: center;color: #808080;font-size: 70%;margn-top: 5px;"><a style="color:inherit" href="?o=1">¿Se le olvidó su contraseña?</a></div>													
                                                              </div>
                                                              <div class="form-group">
                                                                <div class="QapTcha" ></div>		
                                                              </div>
                                                            </fieldset>
                                                            <input style="display:none; width:100%" id="go" class="btn btn-danger" type="submit" value="Acceder" />									
                                                          </form>
                                                        </div>	
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <?php if ($validador_externo=='1'){ ?><div style="text-align:center; font-variant: small-caps; color: red;"><a href="dashboarde.php?data=validar-recibo" target="_blank">validador de recibos de pagos</div><?php } ?>
