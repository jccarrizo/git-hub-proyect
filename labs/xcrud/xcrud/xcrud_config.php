...
{
    // default connection
    public static $dbname = 'metro_inextranet'; // Your database name
    public static $dbuser = 'metrointranet'; // Your database username
    public static $dbpass = 'uCy7TDhW8WaKcaj4'; // // Your database password
    ...
    // alert settings
    public static $email_from = 'jcnavamorffe@gmail.com'; // email from address
    public static $email_from_name = 'xCRUD en la Intranet'; // email from name
    ...
    //public static $rango = '1900:2000'; // jqueryui time format
